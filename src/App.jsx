    ...
    <>
        ...
        <section className="home bd-grid section" id="home">
          <div className="home-data">
            <h2 className="home-title">
              Hi 👋,
              <br />
              I'am <span className="home-title-color">Tushar Sahu</span>
              <br />
              <span id="jobTitle">MERN Developer</span>
            </h2>
            <a
              href="https://drive.google.com/file/d/1H08bwDDtPX0422uX1svMEH1xnSEEX1Zt/view?usp=sharing"
              target="_blank"
              className="button"
            >
              Resume
          ...
          <div className="home-social">
            <a
              href="https://www.linkedin.com/in/tushar-sahu-3b9a79204/"
              target="_blank"
            ...
            <a
              href="https://github.com/tusharsahu2599"
              target="_blank"
              className="home-social-icon"
            >
        ...
        <section className="education section" id="education">
              ...
              <div>
                ...
                <div className="skills-data">
                  <div className="skills-names">
                    <i className="bx bxl-html5 skills-icon" />
          ...
          <div>
              <span class="skills-percentage">75%</span>
                ...
                <div className="skills-data">
                  <div className="skills-names">
                    <i className="bx bxl-css3 skills-icon" />
              ...
              <span class="skills-percentage">70%</span>
                ...
                <div className="skills-data">
                  <div className="skills-names">
                    <i className="bx bxl-javascript skills-icon" />
                    <span className="skills-name">JavaScript</span>
                  </div>
                  {/* <div class="skills-bar skills-css"></div>  */}
                  <div>{/* <span class="skills-percentage">70%</span> */}</div>
                </div>
                <div className="skills-data">
                  <div className="skills-names">
                    <i className="bx bxl-react skills-icon" />
                    <span className="skills-name">React</span>
                  </div>
                  {/* <div class="skills-bar skills-react"></div> */}
                  <div>{/* <span class="skills-percentage">50%</span> */}</div>
                </div>
                <div className="skills-data">
                  <div className="skills-names">
                    <i className="bx bxl-redux skills-icon" />
              ...
              <div>
                ...
                <div className="skills-data">
                  <div className="skills-names">
                    <i className="bx bxl-nodejs skills-icon" />
          ...
          <section className="projects section" id="projects">
            ...
            <div className="project-container">
              <div className="project-img">
                ...
                <p className="project-subtitle">
                  A web application to buy medicines online by uploading the
                  prescriptions. Features: User authentication Prescription upload
                  feature. <br />
                  <br />
                ...
                <div className="project-btns">
                  <a
                    href="https://github.com/tusharsahu2599/medplus"
                    target="_blank"
                  ...
                  <a
                    href="https://tusharsahu2599.github.io/medplus/homepage"
                    target="_blank"
                    className="small-btn button"
                  >
                    Live
            ...
            <i class="bx bx-blog"></i> */}
              ...
              <div className="project-img">
                ...
                <div className="project-btns">
                  <a
                    href="https://github.com/salakhas/epicGames"
                    target="_blank"
                    className="small-btn button"
                  >
                    <i className="bx bxl-github" />
                  ...
                  <a
                    href="https://epic-games-web.vercel.app/"
                    target="_blank"
                    className="small-btn button"
                  >
                    Live
                  ...
                  <a
                    href="https://medium.com/@ssalakha16/building-a-clone-of-epic-games-7f3c5b4ab59c"
                    target="_blank"
                    className="small-btn button"
                  >
                    Blog
                    <i className="bx bx-blog" />
                  </a>
                </div>
              </div>
              <div className="project-img">
                ...
                <div className="project-btns">
                  <a
                    href="https://github.com/tusharsahu2599/Youtube-mini-clone"
                    target="_blank"
                    className="small-btn button"
                  >
                    <i className="bx bxl-github" />
          ...
          <a href="https://medium.com/@hgauba4/how-did-our-team-build-the-mednear-clone-241227129f79" target="_blank"
            ...
            <i class="bx bx-blog"></i> */}
              ...
              <div className="project-img">
                ...
                <div className="project-btns">
                  <a
                    href="https://github.com/tusharsahu2599/portfolio"
                    target="_blank"
                    className="small-btn button"
                  >
                    <i className="bx bxl-github" />
          ...
          <a href="https://medium.com/@hgauba4/how-did-our-team-build-the-mednear-clone-241227129f79" target="_blank"
            ...
            <i class="bx bx-blog"></i> */}
              ...
              <div className="project-img">
                ...
                <div className="project-btns">
                  <a
                    href="https://github.com/h1t3ndr4/Swiggy-Clone"
                    target="_blank"
                    className="small-btn button"
                  >
                    Code
                  ...
                  <a
                    href="https://swiggy-bwjc9njal-premkumar-hulikoppe.vercel.app/"
                    target="_blank"
                    className="small-btn button"
                  >
                    Live
              ...
              <div className="project-img">
                ...
                <div className="project-btns">
                  ...
                  <a
                    href="https://mern-tinde-chater.herokuapp.com/"
                    target="_blank"
                    className="small-btn button"
                  >
                    Live
              ...
              <div className="project-img">
                ...
                <div className="project-btns">
                  <a
                    href="https://github.com/tusharsahu2599/Redux-app"
                    target="_blank"
                    className="small-btn button"
                  >
                    Code
                  ...
                  <a
                    href="https://react-redux-routing.vercel.app/"
                    target="_blank"
                    className="small-btn button"
                  >
                    Live
      ...
      <footer className="footer section" id="contact">
        ...
        <div className="footer-social">
          ...
          <a
            href="https://twitter.com/Tushars2526"
            target="_blank"
            className="footer-icon"
          >
          ...
          <a
            href="mailto:tksahu1234@gmail.com"
            target="_blank"
            className="footer-icon"
          >
          ...
          <a href="tel:+91 8839819475" target="_blank" className="footer-icon">
